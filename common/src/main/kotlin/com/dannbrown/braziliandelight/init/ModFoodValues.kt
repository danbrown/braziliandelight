...
object AddonFoodValues {
  ...
  val BRAZILIAN_DINNER = FoodProperties.Builder()
    .nutrition(10)
    .saturationMod(1f)
    .effect(MobEffectInstance(FarmersCompat.getNourishment(), LONG_DURATION, 1), 1.0f)
    .build();
  ...
  val PLATE_OF_STROGANOFF = FoodProperties.Builder()
    .nutrition(5)
    .saturationMod(0.8f)
    .effect(MobEffectInstance(FarmersCompat.getNourishment(), MEDIUM_DURATION, 1), 1.0f)
    .build();
  val PLATE_OF_GREEN_SOUP = FoodProperties.Builder()
    .nutrition(4)
    .saturationMod(0.6f)
    .effect(MobEffectInstance(FarmersCompat.getComfort(), MEDIUM_DURATION, 1), 1.0f)
    .build();
  val PLATE_OF_FISH_MOQUECA = FoodProperties.Builder()
    .nutrition(5)
    .saturationMod(0.8f)
    .effect(MobEffectInstance(FarmersCompat.getComfort(), SHORT_DURATION, 1), 1.0f)
    .build();
