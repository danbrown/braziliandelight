...
class CoconutProjectileEntity : ThrowableItemProjectile {
  ...
  constructor(pLevel: Level) : super(ModEntityTypes.COCONUT_PROJECTILE.get(), pLevel)
  constructor(pLevel: Level, livingEntity: LivingEntity) : super(
    ModEntityTypes.COCONUT_PROJECTILE.get(),
    livingEntity,
    pLevel
  )

  constructor(level: Level, x: Double, y: Double, z: Double) : super(
    ModEntityTypes.COCONUT_PROJECTILE.get(), x, y, z, level
  )

  override fun getDefaultItem(): Item {
    return ModBlocks.COCONUT.getItem()
  }

  private fun getSliceItem(): Item {
    return ModItems.COCONUT_SLICE.get()
  }
