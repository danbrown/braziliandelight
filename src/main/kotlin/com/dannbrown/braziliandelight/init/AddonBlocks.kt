...
object AddonBlocks {
  ...
  val SWEET_LOVE_APPLE_TRAY: BlockEntry<LoveAppleTrayBlock> = FeastBuilderPresets.createLoveAppleTrayBlock(
    AddonNames.SWEET_LOVE_APPLE_TRAY,
    MapColor.COLOR_RED
  ...
  val POTTED_LEMON_SAPLING =
    SaplingBuilderPresets.createPottedBlock(AddonNames.LEMON, MapColor.COLOR_LIGHT_GREEN, { LEMON_SAPLING.get() })
  ...
  val POTTED_ACAI_PALM_SAPLING =
    SaplingBuilderPresets.createPottedBlock(AddonNames.ACAI_PALM, MapColor.COLOR_PURPLE, { ACAI_PALM_SAPLING.get() })
  ...
  val FALLING_COCONUT: BlockEntry<FallingCoconutBlock> =
    CoconutBuilderPresets.createFallingCoconutBlock(AddonNames.COCONUT, MapColor.COLOR_BROWN) { COCONUT.get() }
}
