...
object AddonLangGen {
  fun addStaticLangs(doRun: Boolean) {
    ...
    AddonContent.REGISTRATE.addAdvancementLang(AddonAdvancementsProvider.GUARANA_DRINK_CRAFT_KEY, "Como Refresca!", "Craft Guarana Drink")
    AddonContent.REGISTRATE.addAdvancementLang(AddonAdvancementsProvider.LEMON_ITEM_KEY, "Zesty Lemon", "Obtain a Lemon")
    ...
    AddonContent.REGISTRATE.addAdvancementLang(AddonAdvancementsProvider.COCONUT_ITEM_KEY, "Coconut Treasure", "Obtain a Coconut")
    ...
    AddonContent.REGISTRATE.addAdvancementLang(AddonAdvancementsProvider.COXINHA_CRAFT_KEY, "Esse aqui é de que?", "Craft Coxinha")
