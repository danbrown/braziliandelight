...
object RoseateDesertBiome : AbstractBiome() {
  ...
  override fun createBiome(context: BootstapContext<Biome>): Biome {
    ...
    val generationSettings = BiomeGenerationSettings.Builder(placedFeatures, caveGetter)
      // raw generation
      .addFeature(GenerationStep.Decoration.RAW_GENERATION, AddonPlacedFeatures.ROSEATE_BOULDER_PLACED)
      .addFeature(GenerationStep.Decoration.RAW_GENERATION, AddonPlacedFeatures.ROSEATE_SPIKES_PLACED)
      // lakes
      ...
      // local modifications
      .addFeature(GenerationStep.Decoration.LOCAL_MODIFICATIONS, AddonPlacedFeatures.ROSEATE_GEODE_PLACED)
      // .....
      ...
      .addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, AddonPlacedFeatures.SPARSE_DRY_GRASSES_PLACED)
      .addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, AddonPlacedFeatures.PATCH_DEAD_GRASSES_PLACED)
      .addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, AddonPlacedFeatures.PATCH_HIMALAYAN_SALT_PLACED)
      // carvers
